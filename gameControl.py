...
class Game:
    def __init__(self):
        print('\n' + '=' * 50)
        print(
            'Обоим игрокам выдается случайная карточка из чисел, каждый ход выбирается один случайный бочонок (число)')
    ...
    def start_game(self, player1, player2):
        ...
        while self.bag and not (player1.lost or player2.lost):
            ...
            # Пауза только если игра продолжается и есть хотя бы один человек
            if self.bag and (not player1.is_bot or not player2.is_bot):
